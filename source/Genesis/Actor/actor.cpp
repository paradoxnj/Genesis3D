...
GENESISAPI void GENESISCC geActor_SetBlendingType( geActor *A, geActor_BlendingType BlendingType )
{
	...
	if (BlendingType == GE_ACTOR_BLEND_LINEAR)
		{
			A->BlendingType = (geActor_BlendingType)GE_POSE_BLEND_LINEAR;
		}
	else
		{
			A->BlendingType = (geActor_BlendingType)GE_POSE_BLEND_HERMITE;
		}
}
								...
								geFloat BlendAmount)
{
	...
	gePose_BlendMotion( A->Pose,M,Time,Transform,
						BlendAmount,(gePose_BlendingType)A->BlendingType);
}
