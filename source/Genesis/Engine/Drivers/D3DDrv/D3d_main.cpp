...
BOOL D3DMain_InitD3D(HWND hWnd, const char *DriverName, int32 Width, int32 Height)
{
	...
	D3DMain_Log(" Build Date: %s, Time: %s\n", __DATE__, __TIME__);
	D3DMain_Log("=================================================================\n\n");
...
{
	DWORD	red_mask = 0, grn_mask = 0, blu_mask = 0, a_mask = 0;
	DWORD	red_shift = 0, grn_shift = 0, blu_shift = 0, a_shift = 0;
	DWORD	red_width = 0, grn_width = 0, blu_width = 0, a_width = 0;
	int		i;
