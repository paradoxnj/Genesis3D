...
const int BACK_CLIPPING_PLANE = 0;
const int LEFT_CLIPPING_PLANE = 1;
const int RIGHT_CLIPPING_PLANE = 2;
const int TOP_CLIPPING_PLANE = 3;
const int BOTTOM_CLIPPING_PLANE = 4;
const int NUM_CLIPPING_PLANES = 5;

typedef int geTClip_ClippingPlane;
