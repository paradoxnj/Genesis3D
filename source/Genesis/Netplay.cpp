                        ...
                        LPVOID lpContext)
{
	...
	if( GlobalSession )
		GlobalSession = static_cast<SESSION_DESC*>(realloc( GlobalSession, gSessionCnt * sizeof(SESSION_DESC)));
	else
		GlobalSession = static_cast<SESSION_DESC*>(malloc( sizeof( SESSION_DESC ) ));
