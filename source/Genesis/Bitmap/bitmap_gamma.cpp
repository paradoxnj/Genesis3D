...
geFloat Gamma;
	...
	geBitmap *Locks[8],*Lock;
		...
		{
			geErrorLog_AddString(-1,"geBitmap_Gamma_Apply : LockforWrite failed",nullptr);
			return GE_FALSE;
		}
		...
		for(mip=0;mip<mipCount;mip++)
		{
			...
			{
				geErrorLog_AddString(-1,"geBitmap_Gamma_Apply : GetInfo failed", nullptr);
				return GE_FALSE;
			}
			...
			{
				geErrorLog_AddString(-1,"geBitmap_Gamma_Apply : GammaCorrect_Data", nullptr);
				Ret = GE_FALSE;
			}
		}
		...
		{
			geErrorLog_AddString(-1,"geBitmap_Gamma_Apply : UnLock failed", nullptr);
			return GE_FALSE;
		}
	}
